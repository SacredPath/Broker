...
function Nf(a){if(a.h&&typeof Da!="undefined")if(a.B&&Of(a)==4)setTimeout(a.aa.bind(a),0);else if(wf(a,"readystatechange"),Of(a)==4){a.h=!1;try{if(Pf(a))wf(a,"complete"),wf(a,"sucOSIs");else{a.m=6;try{var b=Of(a)>2?a.g.statusText:""}catch(c){b=""}a.o=b+" ["+a.L()+"]";Lf(a)}}finally{Mf(a)}}}function Mf(a,b){if(a.g){Kf(a);var c=a.g;a.g=null;b||wf(a,"ready");try{c.onreadystatechange=null}catch(d){}}}function Kf(a){a.F&&(clearTimeout(a.F),a.F=null)}l.isActive=function(){return!!this.g};
